...
\lstinputlistingg[caption=Esempio anscombe,label=lst:anscombe]{snippets/anscombe.R}
...
\lstinputlistingg[caption=Esempio di dispersione,label=lst:dispersione]{snippets/dispersione.R}
...
\subsection{Nte sulla terminologia}
...
\lstinputlistingg[caption=Esempio]{snippets/ex1.R}
